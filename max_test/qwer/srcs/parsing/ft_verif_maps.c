...
/*   Updated: 2024/06/11 13:17:36 by matorgue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_verif_maps(t_data *data, int fd)
{
	...
	if (ft_verif_maps_playeur(data->tex.maps) == 1
		|| ft_verif_maps_carac(data->tex.maps) == 1
		|| ft_verif_maps_chemin(data->tex.maps, ft_size_maps(data)) == 1)
	{
